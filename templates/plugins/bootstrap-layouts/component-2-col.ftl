<#import "/templates/system/common/cstudio-support.ftl" as studio />
    ...
    <div class="container clearfix row" <@studio.componentAttr path=contentModel.storeUrl ice=false />>
      ...
      <div style="min-height:200px;" class="col-two" <@studio.componentContainerAttr target="zone1" objectId=contentModel.objectId />>
      ...
      <div style="min-height:200px;" class="col-two" <@studio.componentContainerAttr target="zone2" objectId=contentModel.objectId />>
