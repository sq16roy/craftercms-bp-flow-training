...
<body id="top">
   ...
   <section id="home" 
        ...
        <div class="home-content">        
            ...
            <div class="row contents">                     
                <div class="home-content-left">
                    ...
                    <h1 data-aos="fade-up" <@studio.iceAttr iceGroup="headlines"/>>${contentModel.headline}</13>
        ...
        <ul class="home-social-list">
          ...
          <section id="about" style="min-height:0px !important; padding: 5px; background-color:black !important;"  >

          <div style="min-height:0px !important; background-color:black !important;" class="row about-intro clearfix" <@studio.componentContainerAttr target="col1" objectId=contentModel.objectId /> >
